...
CREATE TABLE `foto` (
  ...
  `ext` VARCHAR(5) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Extensión del archivo de la foto',
...
CREATE TABLE `marca` (
  ...
  `nombre` VARCHAR(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Nombre de la marca',
  `telefono` VARCHAR(15) COLLATE utf8_unicode_ci NULL COMMENT 'Teléfono de la marca',
  `email` VARCHAR(100) COLLATE utf8_unicode_ci NULL COMMENT 'Dirección de email de la marca',
  `web` VARCHAR(100) COLLATE utf8_unicode_ci NULL COMMENT 'Dirección de la página web de la marca',
  `observaciones` TEXT NULL COMMENT 'Observaciones o notas personales de la marca',
  `created_at` DATETIME NOT NULL COMMENT 'Fecha de creación del registro',
  `updated_at` DATETIME NULL COMMENT 'Fecha de última modificación del registro',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `linea_venta` (
  ...
  `tipo_descuento` INT(11) NOT NULL DEFAULT '0' COMMENT 'Tipo de descuento 0 ninguno 1 porcentaje 2 importe',
  `descuento` INT(11) NOT NULL DEFAULT '0' COMMENT 'Porcentaje de descuento aplicado',
  `cantidad` INT(11) NOT NULL DEFAULT '0' COMMENT 'Cantidad de artículos vendidos',
  `created_at` DATETIME NOT NULL COMMENT 'Fecha de creación del registro',
  `updated_at` DATETIME NULL COMMENT 'Fecha de última modificación del registro',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `categoria` (
  ...
  `nombre` VARCHAR(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Nombre de la categoría',
  `created_at` DATETIME NOT NULL COMMENT 'Fecha de creación del registro',
  `updated_at` DATETIME NULL COMMENT 'Fecha de última modificación del registro',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `pago_caja` (
  ...
  `concepto` VARCHAR(250) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Concepto del pago',
...
CREATE TABLE `codigo_barras` (
  ...
  `codigo_barras` VARCHAR(100) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Código de barras del artículo',
...
CREATE TABLE `proveedor` (
  ...
  `nombre` VARCHAR(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Nombre del proveedor',
  `direccion` VARCHAR(100) COLLATE utf8_unicode_ci NULL COMMENT 'Dirección física del proveedor',
  `telefono` VARCHAR(15) COLLATE utf8_unicode_ci NULL COMMENT 'Teléfono del proveedor',
  `email` VARCHAR(100) COLLATE utf8_unicode_ci NULL COMMENT 'Dirección de email del proveedor',
  `web` VARCHAR(100) COLLATE utf8_unicode_ci NULL COMMENT 'Dirección de la página web del proveedor',
  `observaciones` TEXT NULL COMMENT 'Observaciones o notas personales del proveedor',
  `created_at` DATETIME NOT NULL COMMENT 'Fecha de creación del registro',
  `updated_at` DATETIME NULL COMMENT 'Fecha de última modificación del registro',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `cliente` (
  ...
  `nombre` VARCHAR(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Nombre del cliente',
  `apellidos` VARCHAR(100) COLLATE utf8_unicode_ci NULL COMMENT 'Apellidos del cliente',
  `dni_cif` VARCHAR(10) COLLATE utf8_unicode_ci NULL COMMENT 'DNI/CIF del cliente',
  `telefono` VARCHAR(15) COLLATE utf8_unicode_ci NULL COMMENT 'Teléfono del cliente',
  `email` VARCHAR(100) COLLATE utf8_unicode_ci NULL COMMENT 'Email del cliente',
  `direccion` VARCHAR(100) COLLATE utf8_unicode_ci NULL COMMENT 'Dirección del cliente',
  `codigo_postal` VARCHAR(10) COLLATE utf8_unicode_ci NULL COMMENT 'Código postal del cliente',
  `poblacion` VARCHAR(50) COLLATE utf8_unicode_ci NULL COMMENT 'Población del cliente',
  `provincia` INT(11) NULL COMMENT 'Id de la provincia del cliente',
  `observaciones` TEXT NULL COMMENT 'Campo libre para observaciones personales del cliente',
  `created_at` DATETIME NOT NULL COMMENT 'Fecha de creación del registro',
  `updated_at` DATETIME NULL COMMENT 'Fecha de última modificación del registro',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `articulo` (
  ...
  `nombre` VARCHAR(100) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Nombre del artículo',
  ...
  `observaciones` TEXT NULL COMMENT 'Observaciones o notas sobre el artículo',
  ...
  `referencia` VARCHAR(50) COLLATE utf8_unicode_ci NULL COMMENT 'Referencia original del proveedor',
  ...
  `desc_corta` VARCHAR(250) COLLATE utf8_unicode_ci NULL COMMENT 'Descripción corta para la web',
  `desc` TEXT NULL COMMENT 'Descripción larga para la web',
...
ALTER TABLE `foto`
  ADD KEY `fk_foto_articulo_idx` (`id_articulo`),
  ADD CONSTRAINT `fk_foto_articulo` FOREIGN KEY (`id_articulo`) REFERENCES `articulo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
