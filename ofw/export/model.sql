...
CREATE TABLE `venta` (
  ...
  `pago_mixto` TINYINT(1) NOT NULL DEFAULT  COMMENT 'Indica si se ha hecho un pago mixto',
...
CREATE TABLE `pedido` (
  ...
  `re` TINYINT(1) NOT NULL DEFAULT  COMMENT 'Indica si el pedido tiene RE 1 o no 0',
  `europeo` TINYINT(1) NOT NULL DEFAULT  COMMENT 'Indica si se rata de un pedido europeo 1 o no 0',
  `faltas` TINYINT(1) NOT NULL DEFAULT  COMMENT 'Indica si hay faltas en el pedido 1 o no 0',
  `recepcionado` TINYINT(1) NOT NULL DEFAULT  COMMENT 'Indica si se ha recepcionado el pedido 1 o si está pendiente 0',
  `created_at` DATETIME NOT NULL COMMENT 'Fecha de creación del registro',
  `updated_at` DATETIME DEFAULT NULL COMMENT 'Fecha de última modificación del registro',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `linea_pedido` (
  ...
  `id_pedido` INT(11) NOT NULL DEFAULT NULL COMMENT 'Id del pedido al que pertenece la línea',
  `id_articulo` INT(11) NOT NULL DEFAULT NULL COMMENT 'Id del artículo recibido',
  `unidades` INT(11) NOT NULL DEFAULT NULL COMMENT 'Número de unidades recibidas',
  `palb` FLOAT NOT NULL DEFAULT NULL COMMENT 'Precio de albarán del artículo',
  `pvp` FLOAT NOT NULL DEFAULT NULL COMMENT 'PVP del artículo',
  `margen` FLOAT NOT NULL DEFAULT NULL COMMENT 'Porcentaje de margen del artículo',
  `iva` FLOAT NOT NULL DEFAULT NULL COMMENT 'IVA del artículo',
  `re` FLOAT NOT NULL DEFAULT  COMMENT 'RE del artículo',
  `descuento` FLOAT NOT NULL DEFAULT  COMMENT 'Porcentaje de descuento del artículo',
  `created_at` DATETIME NOT NULL COMMENT 'Fecha de creación del registro',
  `updated_at` DATETIME DEFAULT NULL COMMENT 'Fecha de última modificación del registro',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `articulo` (
  ...
  `venta_online` TINYINT(1) NOT NULL DEFAULT  COMMENT 'Indica si el producto está disponible desde la web 1 o no 0',
  `fecha_caducidad` DATETIME DEFAULT NULL COMMENT 'Fecha de caducidad del artículo',
  `mostrar_en_web` TINYINT(1) NOT NULL DEFAULT  COMMENT 'Indica si debe ser mostrado en la web 1 o no 0',
  ...
  `mostrar_obs_pedidos` TINYINT(1) NOT NULL DEFAULT  COMMENT 'Mostrar observaciones en pedidos 0 no 1 si',
  `mostrar_obs_ventas` TINYINT(1) NOT NULL DEFAULT  COMMENT 'Mostrar observaciones en ventas 0 no 1 si',
...
CREATE TABLE `tipo_pago` (
  ...
  `afecta_caja` TINYINT(1) NOT NULL DEFAULT  COMMENT 'Indica si el tipo de pago afecta a la caja',
...
CREATE TABLE `codigo_barras` (
  ...
  `id_articulo` INT(11) NOT NULL DEFAULT NULL COMMENT 'Id del artículo al que pertenece el código de barras',
  `codigo_barras` INT(11) NOT NULL DEFAULT NULL COMMENT 'Código de barras del artículo',
