  ...
  <body>
    ...
    <div class="factura">
				<table class="header">
					<tbody>
						<tr>
							<td><img src="<?php echo $values['logo'] ?>" alt="Logo"></td>
							<td class="right">
								<div class="row-info">
										<label>FECHA:</label>
        ...
        <div class="totales">
            <table>
                <tr>
                    ...
                    <td class="importe">
                      <?php echo number_format($values['subtotal'], 2, ',', '') ?> €
                    </td>
                </tr>
...
<?php endforeach ?>
<?php if ($values['descuento'] != 0): ?>
                <tr>
										<td class="filler">&nbsp;</td>
                    <td class="label">DESCUENTO</td>
                    <td class="importe">
                      <?php echo number_format($values['descuento'], 2, ',', '') ?> €
                    </td>
                </tr>
<?php endif ?>
                <tr>
                    ...
                    <td class="importe importe-total">
                      <?php echo number_format($values['total'], 2, ',', '') ?> €
                    </td>
                </tr>
            </table>
        </div>
